...
# Get accounts number of followers.
...
# score tracker.
  temp = get_score(answer_check(guess))
  score += temp
  if not answer_check(guess):
    print(f"Final score: {score} ")
    break
  print(f"Your score: {score} ")

# Check to continue the game.
  user_input = input("Do you want to keep playing? Type 'Y' or 'N': ").lower()
  if user_input == 'n':
    break
